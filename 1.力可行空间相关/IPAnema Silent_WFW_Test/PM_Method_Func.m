...
%% IPAnema Silent的参数 8绳索6自由度的CDPRs
% ai的定义
a1=[1.432, 1.441, 1.414]';
a2=[1.453, -1.387, 1.413]';
a3=[-1.483, -1.362, 1.422]';
a4=[-1.505, 1.358, 1.430]';
a5=[1.427, 1.454, -1.395]';
a6=[1.453, -1.378, -1.398]';
a7=[-1.483, -1.354, -1.407]';
a8=[-1.510, 1.373, -1.400]';
% bi的定义
b1=Rxyz*[ 0.016, -0.013, 0.068]';
b2=Rxyz*[0.041, 0.020, 0.056]';
b3=Rxyz*[-0.040, 0.013, 0.057]';
b4=Rxyz*[-0.024, -0.009, 0.065]';
b5=Rxyz*[ 0.016, -0.013, -0.068]';
b6=Rxyz*[ 0.041, 0.020, -0.056]';
b7=Rxyz*[-0.040, 0.013, -0.057]';
b8=Rxyz*[-0.024, -0.009, -0.065]';
% 绳索张力的上下限
tM=500;
tm=35;
